...
<div id="undercolumn">
    <div id="undercolumn_shopping">
        ...
        <div class="btn_area">
           <p><input type="submit" value="<!--{t string="tpl_pp30"}-->" class="spbtn spbtn-shopping btn" width="130" height="30" alt="<!--{t string="tpl_pp30"}-->" name="next" id="next" onclick="return fnCheckSubmit();" /></p>
           <p><a href="javascript:;" onclick="fnFormModeSubmit('form1', 'return', '', ''); return false;" class="spbtn spbtn-medeum"><!--{t string="tpl_pp7"}--></a></p>
        </div>
        ...
        <table summary="<!--{t string="tpl_pp56"}-->">
            ...
            <!--{/foreach}-->
            <tr>
                <th colspan="4" class="alignR" scope="row"><!--{t string="tpl_pp35"}--></th>
        ...
        <table summary="<!--{t string="tpl_pp57"}-->" class="delivname">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><!--{t string="tpl_pp45"}--></th>
        ...
        <div class="btn_area">
           <p><input type="submit" value="ご注文完了ページへ" class="spbtn spbtn-shopping" width="130" height="30" alt="<!--{t string="tpl_pp30"}-->" name="next" id="next" onclick="return fnCheckSubmit();" /></p>
           <p><a href="javascript:;" onclick="fnFormModeSubmit('form1', 'return', '', ''); return false;" class="spbtn spbtn-medeum"><!--{t string="tpl_pp7"}--></a></p>
        </div>
        </form>
    </div>
