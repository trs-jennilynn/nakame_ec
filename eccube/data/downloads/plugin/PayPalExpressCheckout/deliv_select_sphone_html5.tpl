<section id="undercolumn">
    <div id="undercolumn_shopping">
        ...
        <div class="pay_area">
            <h3 class="subtitle"><!--{t string="tpl_pp13"}--></h3>
            <p><!--{t string="tpl_pp14"}--></p>
            ...
            <div class="btn_area">
              <ul class="btn_btm">
                ...
                <li><a rel="external" href="javascript:void(document.form1.submit());" class="btn"><!--{t string="tpl_pp8"}--></a></li>
                <li><a rel="external" href="<!--{$smarty.const.CART_URLPATH}-->" class="btn_back"><!--{t string="tpl_pp15"}--></a></li>
            </ul>
          </div>
        </form>
    </div>
