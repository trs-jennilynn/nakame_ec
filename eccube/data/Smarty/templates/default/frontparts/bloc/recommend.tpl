                    ...
                    <div class="item" data-wow-delay="0.1s">
                        <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->">
	                        ...
	                        <div class="item-image">
	                           <img class="lens-image product-list-image" src="<!--{$smarty.const.ROOT_URLPATH}-->resize_image.php?image=<!--{$arrProduct.main_image|sfNoImageMainList|h}-->&amp;" alt="<!--{$arrProduct.name|h}-->" />
	                        </div>
                        </a>
                        <div class="item-info">
                            <h3>
