...
<script>
  window.loadScript = function(src, callback) {
    var script = document.createElement('script')
      , prev   = document.getElementsByTagName('script')[0]
      , loaded = false;
    script.async = true;
    script.src   = src;
...
<!-- twitter top page conversion -->
<script>
loadScript('../platform.twitter.com/oct.js', function() {
  twttr.conversion.trackPid('l4s95');
});
</script>
<noscript>
<img height="1" width="1" style="display:none;" alt="" src="https://analytics.twitter.com/i/adsct?txn_id=l4s95&amp;p_id=Twitter" />
<img height="1" width="1" style="display:none;" alt="" src="http://t.co/i/adsct?txn_id=l4s95&amp;p_id=Twitter" />
</noscript>
<script>
  ...
  mixpanel.init("e749ad9173dfdbb3387c4b9f8d6a7243");
    ...
    <div id='layout'>
        <header class='header'>
            <div class='header-inner'>
                ...
                <ul class='header-navs'><li class='header-nav'><span class='btn-s btn-yellow' id='open-cart'><i class='icon'>&#59197;</i><span id='nav-cart-count'>
                0</span>
                </span></li><li class='header-nav overlay-nav-open'><span class='btn-s btn-blue'><i class='icon'>&#9776;</i><span class='hidden-phone'>メニュー</span></span></li></ul>
            </div>
        </header>
    <nav id='overlay-nav'>
        <div id='overlay-nav-content'>
            <span class='overlay-nav-close btn-s btn-red btn-close'><i class='icon'>&#10060;</i>CLOSE</span>
            <ul class='account-navs'>
                ...
                <li class='account-nav'>
                <a href="terms.html"><span class='account-nav-label account-nav-label-s kerning'>
                会員規約
                </span>
                </a><span>・</span><a href="trading.html"><span class='account-nav-label account-nav-label-s kerning'>
                特定商取引法に基づく表記
                </span>
                </a></li>
                <li class='account-nav'>
