    ...
    <div class="page">
        <div class="flipInY form-container wow animated animated" data-wow-duration="1s" data-wow-iteration="1" style="visibility: visible; -webkit-animation: 1s 1;">
            ...
            <a href="/"><img alt="SUZURI" src="https://dijsur42hqnz1.cloudfront.net/assets/common/suzuri-logo-v-2ba32e5199c85b49e420621545041cf6.svg" width="120px">
                ...
                <div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="2IarLYqYSVnh8w0QHh1rPUV/KiIkRUyFdsMM/RRYWWc=" /></div><div class='signup-id'>
<h4 class='small mar-b-1'>
SUZURI ID でログイン
</h4>
...
<input class="input-text" id="session_name" name="session[name]" placeholder="SUZURI ID" type="text" />
</div>
<div class='form_row'>
<label for="session_password">Password</label>
<input class="input-text" id="session_password" name="session[password]" placeholder="パスワード" type="password" />
</div>
</div>
<input class="btn-m btn-blue loading-submit" name="commit" type="submit" value="ログイン" />
</div>
