<?php /* Smarty version 2.6.26, created on 2014-11-21 11:38:08
...
"><img alt="SUZURI" src="https://dijsur42hqnz1.cloudfront.net/assets/common/suzuri-logo-v-2ba32e5199c85b49e420621545041cf6.svg" width="120px">
                            </a></h1>
                                ...
                                <div class='signup-forms'>
                                    <div class='form_row mar-b-05'>
                                        <label for="session_name">Name</label>
                                            <input class="input-text" id="session_name" name="login_email" placeholder="SUZURI EMAIL" type="text" />
                                    </div>
                                    <div class='form_row'>
...
forgot"><i class='icon'>&#128165;</i><span>パスワードを忘れた</span></a></p>
                            <p class='small'>
                            <a class="link-gray" href="<?php echo ((is_array($_tmp=@HTTP_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
