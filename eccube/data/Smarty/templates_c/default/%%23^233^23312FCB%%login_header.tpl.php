<?php /* Smarty version 2.6.26, created on 2014-11-12 17:05:29
...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'C:\\xampp\\htdocs\\nakame_ec\\eccube\\html/../data/Smarty/templates/default/frontparts/bloc/login_header.tpl', 22, false),array('modifier', 'h', 'C:\\xampp\\htdocs\\nakame_ec\\eccube\\html/../data/Smarty/templates/default/frontparts/bloc/login_header.tpl', 25, false),)), $this); ?>
...
mypage/favorite.php" target="_self"><span class="account-nav-label account-nav-label-m kerning" style="margin-right: 0px; opacity: 1;">
					        ...
					        <li class="account-nav">
					        <a data-no-turbolink="true" href="<?php echo ((is_array($_tmp=@HTTPS_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
mypage/orders" target="_self"><span class="account-nav-label account-nav-label-m kerning" style="margin-right: 0px; opacity: 1;">
					        ...
					        <li class="account-nav">
					        <a data-no-turbolink="true" href="<?php echo ((is_array($_tmp=@HTTPS_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
mypage/profile" target="_self"><span class="account-nav-label account-nav-label-m kerning" style="margin-right: 0px; opacity: 1;">
					        設定
					        </span>
					        </a></li>
					        <li class="account-nav">
					        <a href="<?php echo ((is_array($_tmp=@HTTPS_URL)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
products/list.php" target="_self"><span class="account-nav-label account-nav-label-s kerning" style="margin-right: 0px; opacity: 1;"><i class="icon">?</i>商品を<span style="letter-spacing:-0.075em">探</span><span style="letter-spacing:-0.12em">し</span>てまわる
					        </span>
					        </a></li>
					        <li class="account-nav">
