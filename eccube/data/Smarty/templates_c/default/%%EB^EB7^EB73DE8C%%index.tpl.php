        ...
        <div class='page'>
            <div class='content shop'>
                <div class='previews items-container' data-omikuji='null' id='products'>
                    <?php $_from = ((is_array($_tmp=$this->_tpl_vars['getproducts'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['get_products'] = array('total' => count($_from), 'iteration' => 0);
...
resize_image.php?image=<?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['main_list_image'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" />
		                    ...
		                    <div class='item-info'>
		                        <div class='clearfix'>
		                            <div class='float-l'><h1 class='material-title small'><a class="product-permalink" href="zuro01/435/t-shirt/s/white.html"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</a></h1><span class='item-author small'><a href="zuro01.html"><img alt="Icon default" class="profile-avatar-list" src="../upload/mypage/profile/<?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['zip02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" width="20" /><?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['name01'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
		                            ...
		                            &yen;<?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['price02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>

		                            </span>
		                            </div>
		                            <form name="disp" id="disp" method="post" action="?">
				                        <div class='float-r pad-t-05'>
				                            <button class='btn btn-trans favorite-button'><i class='icon text-red'>&hearts;</i><span class='favorites-count'><?php echo ((is_array($_tmp=$this->_tpl_vars['arrProduct']['total'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span></button>
				                        </div>
			                        </form>
		                        </div>
