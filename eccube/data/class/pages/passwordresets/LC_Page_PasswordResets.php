 ...
 * @version $Id: LC_Page_PasswordResets.php 22796 2013-05-02 09:11:36Z h_yoshimoto $
 */
class LC_Page_PasswordResets extends LC_Page_Ex {
    ...
    function init() {
        ...
        $this->tpl_mainpage = 'password_resets/index.tpl';
        $this->tpl_mainno = '';
            ...
            case 'mail_check':
                ...
                if (SC_Utils_Ex::isBlank($this->arrErr)) {
                    ...
                    if (SC_Utils_Ex::isBlank($this->errmsg)) {
                        $this->tpl_mainpage = 'password_resets/secret.tpl';
                    }
                }
                break;
            case 'secret_check':
                ...
                if (SC_Utils_Ex::isBlank($this->arrErr)) {
                    ...
                    if (SC_Utils_Ex::isBlank($this->errmsg)) {
                        // 完了ページへ移動する
                        $this->tpl_mainpage = SC_Response_Ex::sendRedirect(HTTP_URL . 'login/');
      ...
      //      $is_authorized = false;
          ...
          ////  if ($is_authorized) {
              ...
              //  if (FORGOT_MAIL == 1) {
                    ...
                    $this->lfSendMail($CONF, $arrForm['email'], $new_password);
              //  }
                $sqlval = array();
